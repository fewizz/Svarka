...
public class CraftBlock implements Block {
    ...
    public byte getLightFromSky() {
        return (byte) chunk.getHandle().getLightFor(EnumSkyBlock.SKY, new BlockPos(this.x, this.y, this.z));
    }

    public byte getLightFromBlocks() {
        return (byte) chunk.getHandle().getLightFor(EnumSkyBlock.BLOCK, new BlockPos(this.x, this.y, this.z));
    }
    ...
    public static Biome biomeBaseToBiome(net.minecraft.world.biome.Biome base) {
        ...
        return Biome.valueOf(net.minecraft.world.biome.Biome.REGISTRY.getNameForObject(base).getResourcePath().toUpperCase());
    }
    ...
    public static net.minecraft.world.biome.Biome biomeToBiomeBase(Biome bio) {
        ...
        return net.minecraft.world.biome.Biome.REGISTRY.getObject(new ResourceLocation(bio.name().toLowerCase()));
    }
